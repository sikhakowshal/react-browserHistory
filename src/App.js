...
class App extends Component {
  ...
  render() {
    ...
    const isFilteredListEmpty = filteredHistoryList.length === 0
    ...
    const nullContainer = (
      <div className="null-container">
        <h1 className="no-history-text">There is no history to show</h1>
      </div>
    )
    ...
    return (
      <div className="bg-container">
        ...
        {isFilteredListEmpty ? nullContainer : responsiveContainer}
      </div>
    )
  }
}
